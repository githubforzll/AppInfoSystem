package cn.appsys.dao.appInfo.developer;
...
public interface AppInfoMapper {
	 ...
	 * @return
	 */
	public Integer removeAppInfoById(@Param("id")Integer id);
	 ...
	 * @return
	 */
	public AppInfo queryAppInfoByAPKName(@Param("APKName")String APKName);
